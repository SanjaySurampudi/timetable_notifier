...
let supabaseUrl = cleanEnvValue(rawSupabaseUrl) || 'https://placeholder-project.supabase.co';
const supabaseAnonKey = cleanEnvValue(rawSupabaseAnonKey) || 'placeholder-anon-key';

// Auto-format if they only provided the 20-character reference ID or a domain without protocol
